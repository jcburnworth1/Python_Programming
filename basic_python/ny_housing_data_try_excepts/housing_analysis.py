...
brooklyn_one_bed = pd.read_csv('basic_python/ny_housing_data_try_excepts/brooklyn-one-bed.csv')
brooklyn_price = brooklyn_one_bed['rent']

manhattan_one_bed = pd.read_csv('basic_python/ny_housing_data_try_excepts/manhattan-one-bed.csv')
manhattan_price = manhattan_one_bed['rent']

queens_one_bed = pd.read_csv('basic_python/ny_housing_data_try_excepts/queens-one-bed.csv')
