...
## Read in the data
aaron_judge = pd.read_csv('sports_vector_machine/aaron_judge.csv')
jose_altuve = pd.read_csv('sports_vector_machine/jose_altuve.csv')
david_ortiz = pd.read_csv('sports_vector_machine/david_ortiz.csv')
